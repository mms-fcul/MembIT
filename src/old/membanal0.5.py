    ...
    def analyseTrajectory(self):
        ...
        for frame in traj:
            ...
            if self._thickness:
                ...
                # Get the Center_of_Interest atoms in the two Monolayers
...
class Membrane(AtomCollections):
    ...
    def getThickness(self, CoI, leaflet, box, parameters, outputfile, printnatoms):
        box_x = box[0]
        box_y = box[1]
        box_z = box[2]
...
if __name__ == '__main__':
    ...
    membanal = membanal_helper.Trajectory(trajfile, indexfile, distance_criteria,
                                          outputfile, thickness, insertion, printnatoms)
